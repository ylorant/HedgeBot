...
class CustomCommands extends Plugin
{
     ...
     *
     * @param string $commandName The command name to save.
     *                            If this is an update and the name of the command is to be changed,
     *                            then this parameter has to be the *old* name of the command,
     *                            to allow proper replacement.
